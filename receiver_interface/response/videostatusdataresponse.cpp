#include "videostatusdataresponse.h"
...
VideoStatusDataResponse::VideoStatusDataResponse()
{
...
QStringList VideoStatusDataResponse::getMsgIDs()
{
    return QStringList() << "VST";
}

QString VideoStatusDataResponse::getResponseID()
{
    return "VideoStatusDataResponse";
}

bool VideoStatusDataResponse::parseString(QString str)
{
...
QString VideoStatusDataResponse::getSummary()
{
    QString summary, str;
...
QString VideoStatusDataResponse::getSupportedColorSpace(QString str)
{
    QString cs;
